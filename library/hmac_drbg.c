...
static const unsigned char hmac_drbg_entropy_pr[] = {
...
static const unsigned char hmac_drbg_entropy_nopr[] = {
...
int mbedtls_hmac_drbg_self_test( int verbose )
{
    ...
    CHK( mbedtls_hmac_drbg_seed( &ctx, md_info,
                         hmac_drbg_self_test_entropy, (void *) hmac_drbg_entropy_pr,
                         NULL, 0 ) );
    ...
    test_offset = 0;
    CHK( mbedtls_hmac_drbg_seed( &ctx, md_info,
                         hmac_drbg_self_test_entropy, (void *) hmac_drbg_entropy_nopr,
                         NULL, 0 ) );
